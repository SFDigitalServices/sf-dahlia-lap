  ...
  module Graphql
    ...
    class LeaseUpApplications < Force::GraphqlQuery
      def initialize(user, params)
        ...
        @query_string = build_lease_up_applications_query(@params, @paging_cursor)
      end
      ...
      def build_lease_up_applications_query(opts, cursor)
                ...
                )
                {
                  edges {
                    node {
                      ...
                      Upload_URL__c {value}
                      Leaseup_Appointment_Scheduling_URL__c {value}
                      Applicant__r {
                        First_Name__c {value}
                        Last_Name__c {value}
                        Email__c {value}
