...
export const mapApplicationPreference = (value) => {
  return {
    ...
    id: value.Id,
    name: value.Name,
    preference_name: value.Preference_All_Name || value.Preference_Name,
    ...
    preference_lottery_rank: value.Preference_All_Lottery_Rank || value.Preference_Lottery_Rank,
