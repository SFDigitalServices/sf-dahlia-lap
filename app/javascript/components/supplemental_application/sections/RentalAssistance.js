...
const AddRentalAssistanceForm = ({ values, onSave, loading, onClose, applicationMembers, onDelete, isNew, form }) => {
  ...
  return (
    <Form
    onSubmit={onSave}
    initialValues={form.getState().values['rental_assistance']}
