...
const YesNoRadioGroup = ({ field, uniqId, trueValue = 'true', trueLabel = 'Yes', falseValue = 'false', falseLabel = 'No' }) => {
  return (
        ...
        {(group) => (
          <React.Fragment>
            <p className='radio-inline'>
              <Radio group={group} value={trueValue} id={`${field}-${uniqId}-yes`} />
              <label className='radio-inline_label' htmlFor={`${field}-${uniqId}-yes`}>{trueLabel}</label>
            </p>
            <p className='radio-inline'>
              <Radio group={group} value={falseValue} id={`${field}-${uniqId}-no`} />
