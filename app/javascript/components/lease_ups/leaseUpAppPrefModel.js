export const buildLeaseUpAppPrefModel = (applicationPreference) => {
  ...
  const isGeneralPreference = applicationPreference.preference_name && applicationPreference.preference_name.includes('General')
  const recordType = applicationPreference.record_type_for_app_preferences || ''
  const preferenceRecordType = isGeneralPreference ? applicationPreference.preference_name : recordType
