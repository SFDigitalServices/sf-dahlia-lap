  ...
  return [
    {
      ...
      name: 'Krissy 4/13',
      application_due_date: '2018-05-04T17:00:00.000+0000',
      lottery_date: null,
...
const listingDetail = () => {
  return {
    ...
    building_selection_criteria:
      'https://us.awp.autotask.net/1/filelink/113bd-37ed41a1-53a7f01459-2',
...
const applicationsList = () => {
  return [
    {
      id: 'a0r0x000002BhjHAAS',
      'listing.name': 'TEST Listing',
      rule_name: 'Residence Address',
      total_number_of_duplicates: 1
    },
    {
      Id: 'a0r0x000002BhjHAAS',
      'listing.name': 'TEST Listing',
