...
describe('SupplementalApplicationPage', () => {
  ...
  test('should allow new rental assistances to be created', async () => {
    let browser = await puppeteer.launch({ headless: HEADLESS, slowMo: 150 })
    let page = await browser.newPage()
    ...
    await page.click('button.rental-assistance-add')
    ...
    await page.type('.rental-assistance-form .rental-assistance-amount', amount)
